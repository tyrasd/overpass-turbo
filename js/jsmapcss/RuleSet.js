...
styleparser.RuleSet.prototype = {
    ...
    parseCSS: function(css) {
        ...
        while (css.length>0) {
            ...
            if ((o=this.COMMENT.exec(css))) {
                ...
                sc.currentChain().addConditionToLast((new styleparser.Condition()).init('set',o[1]));
                ...
                sc.currentChain().addConditionToLast((new styleparser.Condition()).init('unset',o[1]));
                previous=this.oCONDITION;
    ...
    parseCondition:function(s) {
        var o={};
        if      ((o=this.CONDITION_TRUE.exec(s)))  { return (new styleparser.Condition()).init('true'	,o[1]); }
        else if ((o=this.CONDITION_FALSE.exec(s))) { return (new styleparser.Condition()).init('false',o[1]); }
        else if ((o=this.CONDITION_SET.exec(s)))   { return (new styleparser.Condition()).init('set'	,o[1]); }
        else if ((o=this.CONDITION_UNSET.exec(s))) { return (new styleparser.Condition()).init('unset',o[1]); }
        else if ((o=this.CONDITION_NE.exec(s)))    { return (new styleparser.Condition()).init('ne'	,o[1],o[2]); }
        else if ((o=this.CONDITION_GT.exec(s)))    { return (new styleparser.Condition()).init('>'	,o[1],o[2]); }
        else if ((o=this.CONDITION_GE.exec(s)))    { return (new styleparser.Condition()).init('>='	,o[1],o[2]); }
        else if ((o=this.CONDITION_LT.exec(s)))    { return (new styleparser.Condition()).init('<'	,o[1],o[2]); }
        else if ((o=this.CONDITION_LE.exec(s)))    { return (new styleparser.Condition()).init('<='	,o[1],o[2]); }
        else if ((o=this.CONDITION_REGEX.exec(s))) { return (new styleparser.Condition()).init('regex',o[1],o[2]); }
        else if ((o=this.CONDITION_EQ.exec(s)))    { return (new styleparser.Condition()).init('eq'	,o[1],o[2]); }
        return null;
    },
